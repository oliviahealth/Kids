...
import { WPHeader, WPContainer, WPActivityPreview, WPTitle } from '@/components/WhitePage';
...
export default ({ onBack, onContinue, onExit }: Page) => <WPContainer backText="Back" onBack={onBack} onContinue={onContinue} onExit={onExit}>
    ...
    <WPTitle title={"Guidelines"} />
    <div className="flex justify-between">
        <WPActivityPreview hideTitle={true} color={"#A2F3C3"} activities={[
            {
                id: 1,
