...
import NightMascot from "../../../../../public/images/Group 115.svg";
import pageNumber from "../../../../../public/images/page4.svg";
...
const MeditationActivityPage4: React.FC<{
  ...
  return (
    <div
      style={{ overflow: "hidden", height: "100vh", backgroundColor: '#FEEE61' }}
      className="relative w-full h-full flex justify-center items-start"
    >
      <Link href="/home">
        <div className="absolute top-0 right-0 m-4 w-20 h-20 bg-[#F5DD00] rounded-full flex justify-center items-center cursor-pointer hover-grow-x">
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">Wash up and wind down</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
            Try to bathe children and yourself at the same time everyday. To wind down, try to read a book.
        </p>
        <div className="flex justify-center mt-40">
          <Image src={NightMascot} alt="Night Mascot" width={900} height={900} />
        </div>
      </div>
    </div>
  );
