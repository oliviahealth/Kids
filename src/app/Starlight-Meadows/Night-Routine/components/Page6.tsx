...
import pageNumber from "../../../../../public/images/page3.svg";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">Remove distractions</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
            Put up cell phones and toys. Set a time to clean everything up.
        </p>
