...
import pageNumber from "../../../../../public/images/page2.svg";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">Set a schedule</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
            Pick a time to go to bed and try to sleep at the same time everyday. 
        </p>
