...
import NightMascot from "../../../../../public/images/Group 89.svg";
import pageNumber from "../../../../../public/images/Group 59.svg";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">Creating a nighttime routine</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
          Grab your materials and click continue to get started
        </p>
        <div className="flex justify-center mt-10">
          <Image src={NightMascot} alt="Night Mascot" width={700} height={700} />
        </div>
      </div>
    </div>
  );
