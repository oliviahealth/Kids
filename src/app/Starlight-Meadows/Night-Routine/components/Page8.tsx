...
import pageNumber from "../../../../../public/images/page5.svg";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">Setting traditions</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
            Set time for any other important nighttime activities your family is used to.
        </p>
