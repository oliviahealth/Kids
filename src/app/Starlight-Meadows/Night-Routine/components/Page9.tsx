...
import pageNumber from "../../../../../public/images/page6.svg";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">You are finished!</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
            Remember to try to stick to this routine and avoid caffeine and distractions close to bedtime. 
        </p>
