...
import pageNumber from "../../../../../public/images/neckpage1.png";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">Neck Rotations</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
          Release built up tension by increasing range of motion.
        </p>
        <div className="text-center mt-96 w-full">
          <p className="text-3xl font-bold mb-4">
            Sit or stand up straight, relax your shoulders, and slowly move your head in a circle, first to the right and then to the left, while breathing deeply. Repeat this 5-10 times to help your neck feel better and more flexible.
          </p>
        </div>
      </div>
    </div>
