...
const Map: React.FC = () => {
  ...
  const [markers, setMarkers] = useState<Marker[]>([
    { id: 1, top: '15%', left: '15%', x: 0, y: 0, link: '/Starlight-Meadows/Night-Routine' },
    { id: 2, top: '30%', left: '40%', x: 0, y: 0, link: '/Starlight-Meadows/Stretching' },
    { id: 3, top: '50%', left: '60%', x: 0, y: 0, link: '/Starlight-Meadows/Box-Breathing' },
    { id: 4, top: '70%', left: '80%', x: 0, y: 0, link: '/Starlight-Meadows/Walking' },
  ]);
