...
import pageNumber from "../../../../../public/images/ypage7.svg";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-20 w-full">
        <h1 className="text-5xl font-extrabold mb-8 fade-in">Repeat</h1>
        <p className="text-xl font-semibold mb-2 fade-in">
            You may repeat this activities as many times as you wish, or just do it one time.  
        </p>
