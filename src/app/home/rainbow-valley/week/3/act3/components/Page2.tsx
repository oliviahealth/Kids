...
const Page2: React.FC<{
  ...
  const activitySteps: ActivityStep[] = [
    ...
    },
    {
      stepNumber: 6,
      description:
        "If the child had a hard time during this activity, talk with them about why they did not want to share. Explain the importance of sharing and how it gives everyone a chance to play with that toy, and them a chance to find a new one.",
    },
  ];
