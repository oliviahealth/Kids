      ...
      <div className="space-y-10">
        <div className="flex justify-between">
          ...
          <div className="my-auto mt-24 text-center">
            <h1 className="text-2xl font-black ">Recall and register</h1>
            <p className="text-lg font-semibold">
              Before getting out think back to what you saw, heard, smelt, felt,
              and possibly tasted and how you were able to be safe.
            </p>
          </div>
