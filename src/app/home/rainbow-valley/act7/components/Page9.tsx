...
import rainbowValleyActivity7Page9SideImage from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_SideImage.png";
import rainbowValleyActivity7Page9Image1 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image4.png";
import rainbowValleyActivity7Page9Image2 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image4.png";
import rainbowValleyActivity7Page9Image3 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image4.png";

import Link from "next/link";
const RainbowValleyActivity7Page9: React.FC<{
  onNext: () => void;
  onBack: () => void;
}> = ({ onNext, onBack }) => {
  return (
      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-10 space-y-5 sm:space-y-0 ">
              <div>
                <Image
                  ...
                  src={rainbowValleyActivity7Page9Image1}
                  alt="Olivia Kids"
                ></Image>
              </div>
              <div>
                <Image
                  className="rounded-2xl h-full w-full"
                  src={rainbowValleyActivity7Page9Image2}
                  alt="Olivia Kids"
                ></Image>
              </div>
              <div>
                <Image
                  className="rounded-2xl h-full w-full"
                  src={rainbowValleyActivity7Page9Image3}
                  alt="Olivia Kids"
                ></Image>
              </div>
            </div>
          ...
          <div className="col-span-4 order-1 sm:order-2">
            <Image
              className="w-full"
              src={rainbowValleyActivity7Page9SideImage}
              alt="Olivia Kids"
            ></Image>
          </div>
        </div>
...
export default RainbowValleyActivity7Page9;
