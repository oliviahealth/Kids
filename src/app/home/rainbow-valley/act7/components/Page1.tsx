        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
          <div className="col-span-8 space-y-5 order-2 sm:order-1">
            ...
            <p>
              ...
              children. Kids ages 2-3 have enormous amounts of energy which can
              be difficult as a caregiver. That is why self care helps you take
              care of yourself to ensure that you are giving the children an
              uplifting environment to grow up in. The National Institute of
              Mental Health (NIH) wrote an article about{" "}
              <a
