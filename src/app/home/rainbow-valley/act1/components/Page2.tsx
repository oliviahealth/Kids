...
import rainbowValleyActivity1Page2SideImage from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_SideImage.png";
import rainbowValleyActivity1Page2Image1 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image1.png";
import rainbowValleyActivity1Page2Image2 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image2.png";
import rainbowValleyActivity1Page2Image3 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image3.png";

const RainbowValleyActivity1Page2: React.FC<{
  onNext: () => void;
  onBack: () => void;
}> = ({ onNext, onBack }) => {
  return (
      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-5 space-y-5 sm:space-y-0">
              <div className="mx-auto">
                <Image
                  ...
                  src={rainbowValleyActivity1Page2Image1}
                  alt="Olivia Kids"
                ></Image>
              ...
              <div className="mx-auto">
                <Image
                  className="m-auto h-full object-contain"
                  src={rainbowValleyActivity1Page2Image2}
                  alt="Olivia Kids"
                ></Image>
              ...
              <div className="mx-auto">
                <Image
                  className="m-auto h-full object-contain"
                  src={rainbowValleyActivity1Page2Image3}
                  alt="Olivia Kids"
                ></Image>
          ...
          <div className="col-span-4 order-1 sm:order-2">
            <Image
              className="w-full"
              src={rainbowValleyActivity1Page2SideImage}
              alt="Olivia Kids"
            ></Image>
          </div>
        </div>
...
export default RainbowValleyActivity1Page2;
