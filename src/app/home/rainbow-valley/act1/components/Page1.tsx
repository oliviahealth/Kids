...
import rainbowValleyActivity1Page1SideImage from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_SideImage.png";

const RainbowValleyActivity1Page1: React.FC<{
  onNext: () => void;
  onBack: () => void;
}> = ({ onNext, onBack }) => {
  return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
          <div className="col-span-8 space-y-5 mt-5 sm:m-auto order-2 sm:order-1">
            <div className="space-y-5">
              ...
              <p>
                Listening to music can reduce your stress by helping you focus
                on the lyrics and the tune of the song. As a caregiver of a 2-3
                year old it can be challenging to take time for yourself.
                However it is important to ensure that you are healthy enough to
                properly care for the children. That is why we have created the
                activity, Create Your Own Music Playlist.
              </p>
            </div>
          </div>
          <div className="col-span-4 mt-5 sm:m-auto order-1 sm:order-2">
            <Image
              ...
              src={rainbowValleyActivity1Page1SideImage}
              alt="Olivia Kids"
            ></Image>
          </div>
        </div>
...
export default RainbowValleyActivity1Page1;
