...
import rainbowValleyActivity6Page9SideImage from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_SideImage.png";
import rainbowValleyActivity6Page9Image1 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image4.png";
import rainbowValleyActivity6Page9Image2 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image4.png";
import rainbowValleyActivity6Page9Image3 from "../../../../../../public/images/dashboard/rainbowValley/act1/act1_image4.png";

import Link from "next/link";
const RainbowValleyActivity6Page9: React.FC<{
  onNext: () => void;
  onBack: () => void;
}> = ({ onNext, onBack }) => {
  return (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-10 space-y-5 sm:space-y-0 ">
              <div>
                <Image
                  ...
                  src={rainbowValleyActivity6Page9Image1}
                  alt="Olivia Kids"
                ></Image>
              </div>
              <div>
                <Image
                  className="rounded-2xl h-full w-full"
                  src={rainbowValleyActivity6Page9Image2}
                  alt="Olivia Kids"
                ></Image>
              </div>
              <div>
                <Image
                  className="rounded-2xl h-full w-full"
                  src={rainbowValleyActivity6Page9Image3}
                  alt="Olivia Kids"
                ></Image>
              </div>
            </div>
...
export default RainbowValleyActivity6Page9;
