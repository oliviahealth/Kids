...
export default function PregnancySupportSystemPage3({
  onNext,
  onBack,
}: {
  onNext: () => void;
    ...
    <div className="flex flex-col h-full w-full">
      <div className="h-1/6 flex justify-between items-center gap-8">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <h1 className="text-2xl font-bold">Print the Template</h1>
          <p>First, print out the template provided below, or use any piece of paper available to you.</p>
        </div>
