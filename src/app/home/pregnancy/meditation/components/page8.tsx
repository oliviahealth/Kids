...
const EighthPage: React.FC<EighthPageProps> = ({ onNext, onBack }) => {
  ...
  return (
    <div
      ...
      className="relative w-full h-full flex justify-center items-start meditation-activity-five-bg"
    >
      <Link href="/home">
      ...
      <div className="text-center mt-20">
        ...
        <p className="text-xl font-semibold mb-2">
          You have finished practicing the STOP technique. Here is a star!
        </p>
