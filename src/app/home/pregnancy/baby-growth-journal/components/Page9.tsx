...
export default function BabyGrowthJournalPage9({
  onNext,
  onBack,
}: {
  onNext: () => void;
    ...
    <div className="flex flex-col h-full w-full">
      <div className="h-1/6 flex justify-between items-center gap-8">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <h1 className="text-2xl font-bold">Optional: Add Pictures</h1>
            <p>Include pictures of you and your baby as you grow</p>
        </div>
