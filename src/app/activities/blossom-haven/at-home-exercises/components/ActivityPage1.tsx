    ...
    <div className="flex flex-col h-full w-full">
      <div className="h-1/6 flex justify-between items-center gap-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold">Diaphragmatic breathing - An Easy, Warm Up Breathing Exercise</h1>
          <p>
            Kneel on the floor and put your hands on the floor in front of you.
          </p>

          <p>Place one hand on your stomach, above your belly button, and the other hand on your chest.</p>

          <p>Breathe in slowly through your nose.</p>

          <p>Breathe out slowly through your mouth.</p>

          <p>As you inhale, imagine filling a balloon in your stomach, and as you exhale, imagine shrinking the balloon. Continue breathing in and out for the remaining time.</p>
        </div>
