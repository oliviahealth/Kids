...
import image2 from "/public/images/activities/blossom-haven/week10/cotton.svg";
import image3 from "/public/images/activities/blossom-haven/week10/yarn.svg";
import image4 from "/public/images/activities/blossom-haven/week10/glue.svg";
import image5 from "/public/images/activities/blossom-haven/week10/scissors.svg";
import image6 from "/public/images/activities/blossom-haven/week10/shape.svg";
import image7 from "/public/images/activities/blossom-haven/week10/ribbon.svg";
  ...
  return (
    <>
      ...
      <IntroductionAndMaterials
        ...
        introductionText="A nighttime baby mobile is something that everyone has seen before, or even purchased already, because the touch and sensory benefits that come with them are amazing. Creating a mobile for your 0-1 year old child is a fun creative arts activity that promotes sensory touch exploration for your child to grow and learn more about the world around them. Creating your own mobile for your child creates a personal connection between the two of you, and will assist your child in reaching their growth and development milestones. For this activity, we will provide you with the steps necessary to make a mobile that your child will be interested in to try and reach out for the objects hanging, and promote sensory touch exploration"
        ...
        materials={[
          ...
          { name: "Scissors", image: image5, alt: "image5", key: "image5" },
          { name: "Felt Shapes", image: image6, alt: "image6", key: "image6" },
          { name: "Ribbon", image: image7, alt: "image7", key: "image7" },
