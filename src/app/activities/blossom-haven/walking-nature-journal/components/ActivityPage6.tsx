...
export default function ActivityPage6({
  onNext,
  onBack,
}: {
  onNext: () => void;
    ...
    <div className="flex flex-col h-full w-full">
      <div className="h-1/6 flex justify-between items-center gap-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold">Once you open your journal, begin writing down the different things you saw/took note of. Draw some sketches or explain how each thing you saw made you feel.</h1>
        </div>
