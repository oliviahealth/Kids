...
export default function ActivityPage5({
  onNext,
  onBack,
}: {
  onNext: () => void;
    ...
    <div className="flex flex-col h-full w-full">
      <div className="h-1/6 flex justify-between items-center gap-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold">Schedule these walks when you have the time to yourself or away from the stress at home.</h1>
        </div>
