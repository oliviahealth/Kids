...
import Page2_1 from "./components/Page2.1";
import Page2_2 from "./components/Page2.2";
import Page2_3 from "./components/Page2.3";
...
const PrenatalParadiseActivity: React.FC = () => {
  ...
  const pagesData = [
    ...
    },
    {
      content: (
        <MapContainer>
          <Page2_1 onNext={handleNext} onBack={handleBack} />
        </MapContainer>
      ),
    },
    {
      content: (
        <MapContainer>
          <Page2_2 onNext={handleNext} onBack={handleBack} />
        </MapContainer>
      ),
    },
    {
      content: (
        <MapContainer>
          <Page2_3 onNext={handleNext} onBack={handleBack} />
        </MapContainer>
      ),
    },
    // {
...
export default PrenatalParadiseActivity;
