    ...
    <div className="flex flex-col h-full w-full">
      <div className="h-1/6 flex justify-between items-center gap-8">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <h1 className="text-2xl font-bold">Create a List of Supporters</h1>
          <p>
            With your writing utensil, create a list of people who will provide any form of support to you during and after your pregnancy. This can include someone to talk to when you feel stressed, someone to drive you to your doctors’ appointments, someone to teach you caregiver skills, and much more.
          </p>
        </div>
