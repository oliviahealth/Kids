  ...
  return (
    <div className="flex flex-col justify-between h-full w-full gap-8">
        ...
        >
          ...
          <div className="flex flex-col gap-2 h-full w-full">
            <div className="h-full flex flex-row gap-2 w-full">
              <div
                className={`border-2 h-full w-full rounded-2xl bg-white flex flex-col justify-around items-center p-2 ${isChecked.list ? "border-[#52C5C0]" : "border-[#52C5C0]"
                  }`}
              >
              ...
              <div
                className={`border-2 h-full w-full rounded-2xl bg-white flex flex-col justify-around items-center p-2 ${isChecked.pen ? "border-[#52C5C0]" : "border-[#52C5C0]"
                  }`}
              >
              ...
              <div
                className={`border-2 h-full w-full rounded-2xl bg-white flex flex-col justify-around items-center p-2 ${isChecked.paper ? "border-[#52C5C0]" : "border-[#52C5C0]"
                  }`}
              >
      ...
      <div className="flex justify-between items-end pb-10 lg:pb-5 2xl:pb-0">
        ...
        <div className="">
          <button
            className={`bg-red-600 text-white font-bold py-2 px-4 rounded-3xl flex justify-center items-center ${buttonDisabled ? "opacity-50 cursor-not-allowed" : ""
              }`}
            onClick={onNext}
