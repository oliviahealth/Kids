      ...
      <div className="space-y-10">
        <div className="flex justify-between">
          ...
          <div className="my-auto mt-24 text-center">
            <h1 className="text-2xl font-black ">Observe carefully</h1>
            <p className="text-lg font-semibold">
              Think about what you are hearing as you sit in the car and what
              the seatbelt feels like when you put it on.
            </p>
          </div>
