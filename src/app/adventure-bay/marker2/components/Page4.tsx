    ...
    <div className="flex flex-col h-full justify-between gap-4">
      <div className="flex gap-4">
        ...
        <div className="flex flex-col justify-center items-start">
          <span className="text-xl font-bold">The Power of Coloring for Caregivers</span>
        ...
        <div className="grid gap-8 col-span-7 py-5">
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p>
                Self-care and having ways to relieve stress are so important,
                and coloring is the perfect way to do this after a long day.
                Come back to this activity whenever you or your child need to
                relax your mind. Once completed, you will receive an activity
                completion sticker!
              </p>
            </div>
            <div>
