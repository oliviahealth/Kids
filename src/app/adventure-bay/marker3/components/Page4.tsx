        ...
        <div className="grid gap-8 col-span-7 py-5">
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p>
                All in all, grateful children, as well as grateful adults, make
                for more joyful and thoughtful individuals that are better
                prepared to face day-to-day activities or situations. We can
                never be too old or too young to practice the art of gratitude
                and turn it into an everyday habit. When we practice an attitude
                of gratitude, we are able to be more aware of and thankful for
                the world around us!
              </p>
            </div>
            <div>
