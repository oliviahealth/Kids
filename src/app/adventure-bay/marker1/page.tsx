    ...
    <div className="flex flex-col h-full justify-between gap-4">
      <div className="flex gap-4">
        ...
        <div className="flex flex-col justify-center items-start">
          <span className="text-xl font-bold">{pageContent[0]?.title}</span>
          <span className="text-xl" style={{color: "#52C5C0"}}>{pageContent[0]?.desc}</span>
        </div>
      ...
      <div className="grid md:grid-cols-12 gap-8 grid-cols-1">
        <div className="grid gap-4 col-span-7">
          <div className="grid gap-2">
            <h1 className="text-xl font-bold">{pageContent[0]?.mainContent?.title}</h1>
            <p>
              {pageContent[0]?.mainContent?.content?.part1}
            </p>
            <br></br>
            <p>
              {pageContent[0]?.mainContent?.content?.part2}
            </p>
          </div>
        </div>
